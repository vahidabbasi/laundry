...
public class IntervalDateValidatorTest {
    ...
    public void shouldCheckBookingTimeAvailability() {
        ...
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.plusMinutes(10),
                TO_DATE.minusMinutes(10)));
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.plusMinutes(10), TO_DATE));
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.plusMinutes(10),
                TO_DATE.plusMinutes(5)));
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.plusMinutes(20),
                TO_DATE.plusMinutes(5)));
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE, TO_DATE.minusMinutes(20)));
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.minusMinutes(15),
                TO_DATE.minusMinutes(20)));
        assertFalse(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.minusMinutes(15),
                TO_DATE.minusMinutes(30)));
        assertTrue(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.plusMinutes(35),
                TO_DATE.plusMinutes(9)));
        assertTrue(intervalDateValidator.isTimeAvailable(LAUNDRY_ID, FROM_DATE.minusMinutes(15),
                TO_DATE.minusMinutes(40)));
    }
